...
export default {
  ...
  mounted () {
    console.log("im here")
    this.product = this.$store.getters.getProductById(this.$route.query.id);
  ...
  methods: {
    ...
    saveToFavorite (id) {
      ...
      if (isUserLogged) {
        this.$store.commit('addToFavourite', products);
      } else {
        this.$store.commit('showLoginModal', true);
      }
    },
    removeFromFavourite (id) {
      this.$store.commit('removeFromFavourite', products);
    }
  }
};
</script>
